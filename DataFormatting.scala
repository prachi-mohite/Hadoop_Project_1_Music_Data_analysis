...
object DataFormatting {
  def main(args: Array[String]): Unit = {
    ...
    val load_mob_data = s"""LOAD DATA LOCAL INPATH '/home/acadgild/example/music/data/mob/file.txt'
    ...
    try {
         val xmlData = sqlContext.read.format("com.databricks.spark.xml").option("rowTag", "record").load("/home/acadgild/example/music/data/web/file.xml")
